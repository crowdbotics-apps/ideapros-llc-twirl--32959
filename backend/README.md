...
## Project Structure
    ...
    ├── ideapros_llc_twirl__32959  # Django project configurations
...
1. Clone this repo and `cd ideapros_llc_twirl__32959`
...
2. Clone this repo and `cd ideapros_llc_twirl__32959`
